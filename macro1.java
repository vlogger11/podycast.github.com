...
public class macro1 {
	public static void main(String[] args)
	{
		...
		try {
			String filename = "/home/linuxpc-11/eclipse-workspace/macropass1/src/macropass1/input.txt";
			fr = new FileReader(filename);
			input_file = new BufferedReader(fr);

			String filename1 = "/home/linuxpc-11/eclipse-workspace/macropass1/src/macropass1/MDT.txt";
			fw = new FileWriter(filename1);
			mdt_file = new BufferedWriter(fw);

			String f1 = "/home/linuxpc-11/eclipse-workspace/macropass1/src/macropass1/PNTAB.txt";
			FileWriter fw1 = new FileWriter(f1);
			BufferedWriter pn_file = new BufferedWriter(fw1);

			String f2 = "/home/linuxpc-11/eclipse-workspace/macropass1/src/macropass1/EVNTAB.txt";
			FileWriter fw2 = new FileWriter(f2);
			BufferedWriter evn_file = new BufferedWriter(fw2);

			String f3 = "/home/linuxpc-11/eclipse-workspace/macropass1/src/macropass1/SSNTAB.txt";
			FileWriter fw3 = new FileWriter(f3);
			BufferedWriter ssN_file = new BufferedWriter(fw3);

			String f4 = "/home/linuxpc-11/eclipse-workspace/macropass1/src/macropass1/MNT.txt";
			FileWriter fw4 = new FileWriter(f4);
			BufferedWriter mnt_file = new BufferedWriter(fw4);

			String f5 = "/home/linuxpc-11/eclipse-workspace/macropass1/src/macropass1/KPDTAB.txt";
			FileWriter fw5 = new FileWriter(f5);
			BufferedWriter kpd_file = new BufferedWriter(fw5);

			String f6 = "/home/linuxpc-11/eclipse-workspace/macropass1/src/macropass1/SSTAB.txt";
